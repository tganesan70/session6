...
def find_max_char(line):
    ...
    '''
    return functools.reduce(lambda x,y: x if x> y else y, [ord(x) for x in line])
...
#    print(mod(ord(x) - 97 + 5, 26))
#    print(alphabets[mod(ord(x) - 97 + 5, 26)])

#print(mod(0,26))
#rint(mod(31,26))

#shift_text = shift_alphabets(random_word,5,1)
#shift_text1 = shift_alphabets(shift_text,5,-1)
#print(shift_text,shift_text1)
